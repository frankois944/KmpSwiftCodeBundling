...
/**
 * The Kotlin 2.2 build of the compiler plugin.
 *
 ...
 */
val kotlinCompilerVersion = libs.versions.kotlinCompiler22.get()
val artifactName = "compiler-plugin-kotlin-2.2"
